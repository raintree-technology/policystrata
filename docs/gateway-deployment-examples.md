...
These examples are generic starting points for the customer-hosted Agent Trust Gateway. They keep
runtime manifests and gateway tokens in caller-owned infrastructure. They do not assume Clearance
hosted app auth, private networking, or a specific cloud account.
