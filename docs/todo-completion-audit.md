...
completed by classification to the agent-assurance app TODO, not by implementing hosted app features
...
| Agent-assurance-only work | Verified as out-of-repo classification | `docs/oss-todo-policy.md`, `/Users/mb1/Code/raintree/apps/agent-assurance/todo.txt`, and section 15 wording in root `todo.txt`. |
...
- Reworded section 15 to make clear hosted auth/UI/billing/operations are classified to
  agent-assurance, not implemented in the OSS repository.
