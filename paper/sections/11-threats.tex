...
All scored benchmark domains are synthetic. Public-fault cases map outcomes, while the three BetterOff historical cases probe exact pre/post-fix source contracts rather than execute vulnerable services. Brownfield work covers four open-source repositories and uses synthesized bridge values. The BetterOff pilot is bound to production but its deep checks use synthetic data, and its authenticated probes were skipped. No customer data or independently operated deployment was evaluated.
