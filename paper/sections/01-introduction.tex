...
\begin{itemize}
  ...
  \item a documented retargeting contract plus a deployment-linked, read-only BetterOff pilot over an exact production revision.
\end{itemize}
