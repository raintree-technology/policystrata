-- Adapted (copied unchanged) from src/policystrata/domains/support_saas/seed.sql. See the note in
-- schema.sql: not read by `policystrata run`, provided for self-containment.
