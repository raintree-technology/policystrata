-- Adapted (copied unchanged) from src/policystrata/domains/support_saas/schema.sql. Not read by
-- `policystrata run` (which simulates surfaces from policy.yaml/tasks/*.yaml only); provided for
-- self-containment and for anyone wiring this domain into `policystrata scan` against a real
-- PostgreSQL fixture the way src/policystrata/scanner_examples/postgres_dbt does.
